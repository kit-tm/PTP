package edu.kit.tm.torp2p.raw.network;
...
public class SOCKS {
	...
	public static Socket socks4aSocketConnection(String networkHost, int networkPort, String socksHost, int socksPort, int connectTimeoutMilliseconds) throws IOException {
