...
public class TorManager extends Suspendable {
	...
	public TorManager() throws IOException {
		...
		// Read the PTP home directory from the system environment variable/passed property at runtime. Or use default if neither is set.
		String ptphome = System.getenv(Constants.ptphome);
		if (ptphome == null) ptphome = Constants.ptphomedefault;
