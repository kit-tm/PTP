...
public class PTP {
	 ...
	 * @see Configuration
	 */
	public PTP(String workingDirectory, int controlPort, int socksPort) throws IllegalArgumentException, IOException {
	 ...
	 * @see Configuration
	 */
	public PTP(String workingDirectory, int controlPort, int socksPort, int localPort, String directory) throws IllegalArgumentException, IOException {
		// Read the configuration.
