...
public abstract class Authenticator {
   ...
   */
  public Authenticator(AuthenticationListener listener, MessageChannel channel, Serializer serializer) {
  ...
  /**
   * Tries to authenticate a connection with an unknown remote end.
   * Waits for the other end to authenticate itself first.
   * 
