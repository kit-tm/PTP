...
import edu.kit.tm.torp2p.raw.connection.TTLManager;
...
public class TTLManagerTest {
	...
	/**
	 * Test method for {@link edu.kit.tm.torp2p.raw.connection.TTLManager#Remove(java.lang.String)}.
	 *
	...
	/**
	 * Test method for {@link edu.kit.tm.torp2p.raw.connection.TTLManager#set(java.lang.String, int)}.
	 *
	...
	public void testSet() {
		...
		// Wait for the TTL to expire.
		final long start = System.currentTimeMillis();
		while (!client.disconnected.get() && System.currentTimeMillis() - start < step + expiration + 50) {
			try {
				Thread.sleep(50);
			} catch (InterruptedException e) {
				// Sleeping was interrupted. Do nothing.
